...
#define SWDIO_PIN PC1
#define SWCLK_PIN PC2
...
{
    funPinMode(SWCLK_PIN, GPIO_CFGLR_OUT_10Mhz_PP);
    funPinMode(SWDIO_PIN, GPIO_CFGLR_OUT_10Mhz_PP);
    funDigitalWrite(SWCLK_PIN, FUN_HIGH);
...
{
    funPinMode(SWCLK_PIN, GPIO_CFGLR_IN_FLOAT);
    funPinMode(SWDIO_PIN, GPIO_CFGLR_IN_FLOAT);
}
...
{
    return funDigitalRead(SWCLK_PIN) ? 1U : 0U;
}
...
{
    funDigitalWrite(SWCLK_PIN, FUN_LOW);
}
